...
export const homepageLayoutDefaults: HomepageLayoutItem[] = [
  { key: "events", label: "Prochains events", columns: 4, rows: 5, order: 0 },
  { key: "online", label: "Membres en ligne", columns: 2, rows: 5, order: 1 },
  { key: "announcements", label: "Dernières annonces", columns: 2, rows: 6, order: 2 },
  { key: "activity", label: "Activité récente", columns: 2, rows: 6, order: 3 },
  { key: "almanax", label: "Almanax", columns: 2, rows: 6, order: 4 },
  { key: "gallery", label: "Galerie", columns: 6, rows: 5, order: 5 },
];
