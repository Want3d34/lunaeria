...
const navItems: NavItem[] = legacyNavItems.slice(0, 0).concat([
  ...
  { label: "Élevage", icon: PackageOpen, href: "/ressources/elevage" },
  { label: "Builds", icon: ShieldCheck, href: "/encyclopedie" },
...
const staticSearchItems = [
  ...
  { title: "Ressources", meta: "Onglet", href: "/ressources/elevage" },
  { title: "Élevage", meta: "Ressources", href: "/ressources/elevage" },
  { title: "Stuffs & Builds", meta: "Onglet", href: "/encyclopedie" },
  { title: "Encyclopédie", meta: "Stuffs & Builds", href: "/encyclopedie" },
  { title: "Ajouter un stuff", meta: "Stuffs & Builds", href: "/encyclopedie/ajouter" },
